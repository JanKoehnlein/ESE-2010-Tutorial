 ...
 * <ul>
 *   <li>{@link org.eclipse.ese.android.model.android.impl.ActivityImpl#getName <em>Name</em>}</li>
 *   <li>{@link org.eclipse.ese.android.model.android.impl.ActivityImpl#getWidgets <em>Widgets</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActivityImpl extends EObjectImpl implements Activity {
	...
	public EList<Widget> getWidgets() {
		if (widgets == null) {
			widgets = new EObjectContainmentEList<Widget>(Widget.class, this, AndroidPackage.ACTIVITY__WIDGETS);
		}
		return widgets;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case AndroidPackage.ACTIVITY__WIDGETS:
