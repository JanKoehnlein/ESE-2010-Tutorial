 ...
 * <ul>
 *   <li>{@link org.eclipse.ese.android.model.android.impl.SpinnerImpl#getName <em>Name</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class SpinnerImpl extends EObjectImpl implements Spinner {
	...
	protected EClass eStaticClass() {
		return AndroidPackage.Literals.SPINNER;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, AndroidPackage.SPINNER__NAME, oldName, name));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case AndroidPackage.SPINNER__NAME:
				return getName();
		}
